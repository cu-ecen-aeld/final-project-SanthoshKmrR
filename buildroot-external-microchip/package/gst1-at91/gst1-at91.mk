...
# Skip gtkdocize: the tree uses GTK_DOC_CHECK in configure.ac, but Buildroot
# provides no gtkdocize (only a gtk-doc.m4 stub). Match Buildroot's native
# AUTORECONF which exports GTKDOCIZE=/bin/true. No generated gtk-doc.make is
# included by any built Makefile.am, so this is safe.
define GST1_AT91_RUN_AUTOGEN
	cd $(@D) && PATH=$(BR_PATH) GTKDOCIZE=/bin/true ./autogen.sh --noconfigure
endef
